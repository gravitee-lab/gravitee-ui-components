...
export class GvFlowStep extends withResizeObserver(LitElement) {
  ...
  _renderDropdownMenu () {
    ...
    return html`<gv-dropdown-menu right>
                  ...
                  <gv-button slot="action" class="action action-edit" small link title="Edit" icon="design:edit" @gv-button:click="${this._onEdit}" ?disabled="${this.editing || this.policy == null}">${editLabel}</gv-button>
